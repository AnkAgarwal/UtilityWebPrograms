...
public class TestMutableKey {
	public static void main(String[] args) {
		...
		System.out.println(map.get(a11)); // Prints A_ELEVEN

		// Try with newly created key with same account number
		Account a3 = new Account(11);
